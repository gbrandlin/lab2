...
void deleteAsteroid(Game *g, Asteroid *node)
{
    ...
    delete node;
    node = NULL;
   // ++g.nasteroidsdestroyed; update the numbers just have to find it...
...
void render()
{
    ...
    ggprint8b(&r, 16, 0x00ffff00, "n asteroids destroyed: %i", g.nasteroidsdys);
    //
    //-------------
    //Draw the ship
